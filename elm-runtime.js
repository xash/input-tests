...
Elm.Basics.make = function (_elm) {
   ...
   var toPolar = function (_v12) {
      return function () {
         switch (_v12.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: Native.Basics.sqrt(Math.pow(_v12._0,
                   2) + Math.pow(_v12._1,2))
   ...
   var fromPolar = function (_v16) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: _v16._0 * Native.Basics.cos(_v16._1)
                   ,_1: _v16._0 * Native.Basics.sin(_v16._1)};}
         _E.Case($moduleName,
